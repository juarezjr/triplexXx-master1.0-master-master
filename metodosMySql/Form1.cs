        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (reader.Read()) {
                    ...
                    pictureBox2.ImageLocation = @"Photos\" + entradaCpf.Text + ".jpg";
                    */
                }
            ...
            maisumform.ShowDialog();
            pictureBox2.ImageLocation = @"Photos\" + entradaCpf.Text + ".jpg";
            //pictureBox2.Load("http://i2.kym-cdn.com/photos/images/facebook/000/862/065/0e9.jpg");
        }
            ...
            if (entradaIDLit.Text != "")
            {
                try
                {
                    ...
                    if (reader.Read())
                    {
                        ...
                        //pictureBox2.ImageLocation = @"C:/Users/messyo/Desktop/github/triplexXx-master1.0-master/metodosMySql/Photos/5" + ".jpg";
...
//************************************************** Colocar imagem *********************************************
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            Form3 maisumform = new Form3(this,entradaCpf.Text);
            maisumform.ShowDialog();
            pictureBox2.ImageLocation = @"C:\Users\messyo\Desktop\github\triplexXx-master1.0-master\metodosMySql\Photos\" + entradaCpf.Text + ".jpg";
